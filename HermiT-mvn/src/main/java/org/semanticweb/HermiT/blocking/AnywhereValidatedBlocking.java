...
public class AnywhereValidatedBlocking implements BlockingStrategy {
    private static final Pattern PATTERN_COODE_ONTOLOGY = Pattern.compile("http://www.co-ode.org/ontologies/galen#");
    ...
    protected final class ViolationStatistic implements Comparable<ViolationStatistic> {
        ...
        public String toString() {
            return m_numberOfViolations+": "+PATTERN_COODE_ONTOLOGY.matcher(m_violatedConstraint).replaceAll("");
        }
    }
