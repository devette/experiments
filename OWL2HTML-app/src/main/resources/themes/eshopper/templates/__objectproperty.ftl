...
<#list objectProperty.referencingAxioms as axiom>
     <tr>
         <td><a href="${axiom.subject.filename}.html"><i class="fa fa-circle-o"></i> ${axiom.subject.getLocalLabel(context.locale)}</a></td>
         <td><a href="${axiom.propertyLabel}.html"><nobr><i class="fa fa-long-arrow-right"></i> ${axiom.getLocalLabel(context.locale)}</nobr></a></td>
         <td><a href="${axiom.object.filename}.html"><i class="fa fa-circle-o"></i> ${axiom.object.getLocalLabel(context.locale)}</a></td>
     </tr>
</#list>
</table>
		</div>
