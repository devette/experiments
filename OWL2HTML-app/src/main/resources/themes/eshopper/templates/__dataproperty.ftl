		...
		<div class="panel-body">
			<table class="table">
			   <#list dataProperty.referencingAxioms as p>
				   <tr>
				        <td><i class="fa fa-circle-o"></i> <a href="${p.subject.filename}.html">${p.subject.getLocalLabel(context.locale)}</a></td>
				        <td><a href="${p.propertyLabel}.html"><i class="fa fa-circle"></i> ${p.getLocalLabel(context.locale)}</a></td>        
