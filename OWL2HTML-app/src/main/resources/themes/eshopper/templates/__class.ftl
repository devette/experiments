							...
							<td><div class="post-meta">
									<ul>
										<#list objectProperty.domain as classVO>
									 	    <li><nobr><i class="fa fa-bullseye"></i><a href="${classVO.filename}.html">${classVO.getLocalLabel(context.locale)} ${classVO.extra!}</a></nobr></li>
									    </#list>
									 </ul>
							    </div>
						    <td>
							<td><a href="${objectProperty.propertyLabel}.html"><nobr><i class="fa fa-long-arrow-right"></i> ${objectProperty.getLocalLabel(context.locale)}</nobr></a></td>
						    <td>
						    	<div class="post-meta">
						    		<ul>
